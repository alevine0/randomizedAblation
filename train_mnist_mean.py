...
checkpoint_file = f'./{checkpoint_dir}/mnist_mean_lr_{args.lr}_keep_{args.keep}_epoch_{{}}.pth'
...
if args.resume:
    ...
    checkpoint_file = './{}/mnist_mean_lr_{}_keep_{}_epoch_{}_resume_{}.pth'.format(checkpoint_dir, args.lr, args.keep, '{}', args.resume)
