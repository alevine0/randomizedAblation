...
def random_mask_batch_one_sample(batch, keep_per_image, mean_vec = torch.tensor([0.4914, 0.4822, 0.4465]).cuda(), reuse_noise = False ):
	...
	out_c1 = mean_vec.repeat(batch.shape[0], batch.shape[1]* batch.shape[2],1)
	if (reuse_noise):
